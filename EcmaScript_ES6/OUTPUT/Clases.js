...
var Fernando = new Usuario('Fernando', 18, 'correo@correo.com');
document.write(Fernando.mostrarInfo());
var Sanada = new Usuario('Sanada', 10, 'correo@falso.com');
document.write(Sanada.mostrarInfo());

var Aprendiz = /*#__PURE__*/function (_Usuario) {
  _inherits(Aprendiz, _Usuario);

  var _super = _createSuper(Aprendiz);

  function Aprendiz(Nombre, Edad, Correo, Carrera, Matricula) {
    var _this;

    _classCallCheck(this, Aprendiz);
  ...
  _createClass(Aprendiz, [{
    key: "mostrarInfo",
    value: function mostrarInfo() {
      return "\n        Nombre: ".concat(this.Nombre, " <br/>\n        Edad: ").concat(this.Edad, " <br/>\n        Correo: ").concat(this.Correo, " <br/>\n        Carrera: ").concat(this.Carrera, " <br/>\n        Matricula: ").concat(this.Matricula, " <br/>\n        <hr/>\n        ");
    }
  }]);
...
var Yukimura = new Aprendiz('Yukimura', 20, 'correoBatAss@falso.com', 'Ing. Sisteas', 123456);
